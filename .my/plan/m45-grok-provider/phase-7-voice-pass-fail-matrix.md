...
| Batch STT                 | Record a short clip and call Grokf STT.                              | `/v1/stt` returns readable text and language metadata when available.                        | Record media type, auth, timeout, or rate-limit issue.                 | Not run     |
